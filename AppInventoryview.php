...
$AppInventory_view = NULL; // Initialize page object first

class cAppInventory_view extends cAppInventory {
	...
	// Page object name
	var $PageObjName = 'AppInventory_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "AppInventorylist.php"; // No matching record, return to list
					} else {
			...
			$sReturnUrl = "AppInventorylist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($AppInventory_view)) $AppInventory_view = new cAppInventory_view();

// Page init
$AppInventory_view->Page_Init();

// Page main
$AppInventory_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$AppInventory_view->Page_Render();
?>
...
var CurrentForm = fAppInventoryview = new ew_Form("fAppInventoryview", "view");

// Form_CustomValidate event
fAppInventoryview.Form_CustomValidate = 
...
fAppInventoryview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fAppInventoryview.Lists["x_Support_Team"] = {"LinkField":"x_Support_Team","Ajax":true,"AutoFill":false,"DisplayFields":["x_Support_Team","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"Support_Teams"};
fAppInventoryview.Lists["x_Support_Team"].Data = "<?php echo $AppInventory_view->Support_Team->LookupFilterQuery(FALSE, "view") ?>";
fAppInventoryview.Lists["x_Vendor"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fAppInventoryview.Lists["x_Vendor"].Options = <?php echo json_encode($AppInventory_view->Vendor->Options()) ?>;
fAppInventoryview.Lists["x_Status"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fAppInventoryview.Lists["x_Status"].Options = <?php echo json_encode($AppInventory_view->Status->Options()) ?>;
...
<?php if ($AppInventory->Export == "") { ?>
<div class="ewToolbar">
<?php $AppInventory_view->ExportOptions->Render("body") ?>
<?php
	foreach ($AppInventory_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php } ?>
<?php $AppInventory_view->ShowPageHeader(); ?>
<?php
$AppInventory_view->ShowMessage();
?>
<?php if (!$AppInventory_view->IsModal) { ?>
<?php if ($AppInventory->Export == "") { ?>
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($AppInventory_view->Pager)) $AppInventory_view->Pager = new cPrevNextPager($AppInventory_view->StartRec, $AppInventory_view->DisplayRecs, $AppInventory_view->TotalRecs, $AppInventory_view->AutoHidePager) ?>
<?php if ($AppInventory_view->Pager->RecordCount > 0 && $AppInventory_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($AppInventory_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $AppInventory_view->PageUrl() ?>start=<?php echo $AppInventory_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($AppInventory_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $AppInventory_view->PageUrl() ?>start=<?php echo $AppInventory_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $AppInventory_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($AppInventory_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $AppInventory_view->PageUrl() ?>start=<?php echo $AppInventory_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($AppInventory_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $AppInventory_view->PageUrl() ?>start=<?php echo $AppInventory_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $AppInventory_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<?php } ?>
<form name="fAppInventoryview" id="fAppInventoryview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($AppInventory_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $AppInventory_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="AppInventory">
<input type="hidden" name="modal" value="<?php echo intval($AppInventory_view->IsModal) ?>">
...
<?php if ($AppInventory->ID->Visible) { // ID ?>
	<tr id="r_ID">
		...
		<td data-name="ID"<?php echo $AppInventory->ID->CellAttributes() ?>>
<span id="el_AppInventory_ID">
<span<?php echo $AppInventory->ID->ViewAttributes() ?>>
<?php echo $AppInventory->ID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $AppInventory->Applications->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $AppInventory->Associated_Apps2F_Service->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $AppInventory->IP_Address->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $AppInventory->System_Name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $AppInventory->Support_Team->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $AppInventory->Vendor->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($AppInventory->Url->Visible) { // Url ?>
	<tr id="r_Url">
		...
		<td data-name="Url"<?php echo $AppInventory->Url->CellAttributes() ?>>
<span id="el_AppInventory_Url">
<span<?php echo $AppInventory->Url->ViewAttributes() ?>>
<?php if ((!ew_EmptyStr($AppInventory->Url->ViewValue)) && $AppInventory->Url->LinkAttributes() <> "") { ?>
<a<?php echo $AppInventory->Url->LinkAttributes() ?>><?php echo $AppInventory->Url->ViewValue ?></a>
<?php } else { ?>
<?php echo $AppInventory->Url->ViewValue ?>
<?php } ?>
</span>
</span>
</td>
...
<?php if ($AppInventory->Application_Description->Visible) { // Application Description ?>
	<tr id="r_Application_Description">
		...
		<td data-name="Application_Description"<?php echo $AppInventory->Application_Description->CellAttributes() ?>>
<span id="el_AppInventory_Application_Description">
<span<?php echo $AppInventory->Application_Description->ViewAttributes() ?>>
<?php echo $AppInventory->Application_Description->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $AppInventory->Affected_Users->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $AppInventory->Status->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $AppInventory->Location->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($AppInventory->Export == "") { ?>
<script type="text/javascript">
fAppInventoryview.Init();
</script>
<?php } ?>
<?php
$AppInventory_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($AppInventory->Export == "") { ?>
...
<?php
$AppInventory_view->Page_Terminate();
?>
