...
<?php if (!isset($AuditTrail_view->Pager)) $AuditTrail_view->Pager = new cPrevNextPager($AuditTrail_view->StartRec, $AuditTrail_view->DisplayRecs, $AuditTrail_view->TotalRecs, $AuditTrail_view->AutoHidePager) ?>
